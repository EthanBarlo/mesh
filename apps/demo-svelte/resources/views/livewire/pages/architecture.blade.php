<div class="space-y-12">
    ...
    <x-demo.section
        ...
        :files="['app/Mesh/Architecture/HelloIsland.php', 'resources/js/mesh/Architecture/HelloIsland/index.svelte', 'resources/views/livewire/pages/architecture.blade.php']">
        @php
            $toggles = [
                'hello' => [
                    'name' => 'Hello Island',
...
<span class="text-emerald-400">created</span> <span class="text-zinc-300">resources/js/mesh/Reports/Chart/index.svelte</span></code></pre>
                </div>
            </div>
        </div>
    </x-demo.section>
    ...
    <x-demo.section
        ...
        description="Both sides reduce to the same short id string with no shared config: PHP strips the App\Mesh prefix and swaps backslashes for slashes; JS takes the folder path after resources/js/mesh and drops the trailing /index.svelte. If the two strings match, the tag works.">
        <div class="space-y-6">
            <div class="grid gap-3 lg:grid-cols-[1fr_auto_auto_auto_1fr] lg:items-center">
                ...
                <div class="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    ...
                    <code class="text-sm font-mono text-zinc-400">resources/js/mesh/Forms/Input/index.svelte</code>
                </div>
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div class="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    ...
                    <ul class="mt-2 space-y-1.5 text-xs text-zinc-400">
                        <li class="flex items-center gap-2 text-white"><code class="font-mono font-semibold text-white w-20 shrink-0">.svelte</code> <span aria-hidden="true">&rarr;</span> Svelte <span class="text-[10px] font-medium uppercase tracking-widest text-zinc-500">this app</span></li>
                        ...
                        <li class="flex items-center gap-2"><code class="font-mono text-zinc-300 w-20 shrink-0">.vue</code> <span aria-hidden="true">&rarr;</span> Vue</li>
                    </ul>
