<div class="min-h-screen flex flex-col bg-zinc-950">
    @php
        $steps = [
            [
                'title' => 'Scaffold it',
                'description' => 'One command stubs the PHP class and the Svelte entry file.',
                'snippet' => 'php artisan make:mesh Counter',
            ],
            [
                'title' => 'Shape the props',
                'description' => 'A Livewire component that declares what Svelte receives.',
                'snippet' => 'public function props(): array',
            ],
            [
                'title' => 'Write the Svelte',
                'description' => 'A normal single-file component at index.svelte.',
        ...
        $demos = [
            [
                'route' => 'state',
                'title' => 'State & Props',
                'description' => 'Two-way bind Svelte state to Livewire properties — no API layer to maintain.',
                'icon' => 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99',
            ],
            [
                'route' => 'wire',
                'title' => 'The $wire Bridge',
                'description' => 'Call PHP methods straight from Svelte without writing a single endpoint.',
                'icon' => 'M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z',
            ],
            [
                'route' => 'forms',
                'title' => 'Forms & Validation',
                'description' => 'Server-side validation errors land directly in your Svelte form — no duplication.',
                'icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            ],
            [
                'route' => 'slots',
                'title' => 'Slots',
                'description' => 'Compose Blade content inside Svelte components instead of rebuilding it as templates.',
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-16">
        ...
        <div class="text-center mb-14 max-w-2xl">
            ...
            <p class="text-lg text-zinc-400 leading-relaxed">
                Use the real Svelte ecosystem inside Livewire &mdash; runes, TypeScript and any npm library, backed by your Livewire component's state and methods.
            </p>
        ...
        <div class="mt-24 max-w-5xl w-full">
            ...
            <p class="text-zinc-500 text-center mb-10">Four steps from nothing to a Svelte-powered Livewire component.</p>
    ...
    <footer class="border-t border-white/5 py-6">
        <div class="max-w-5xl mx-auto px-6 text-center text-sm text-zinc-600">
            Built with Laravel, Livewire &amp; Svelte
        </div>
    </footer>
</div>
