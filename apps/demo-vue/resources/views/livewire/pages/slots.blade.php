<div class="space-y-12">
    <x-demo.page-header
        title="Slots"
        description="Blade content placed between a Mesh component's opening and closing tags flows into Vue as the default slot. Wrap a piece in a named livewire:slot and it arrives as a named slot instead — and because the server owns the markup, slot content stays reactive to every Livewire re-render."
    />

    {{-- Section 1: Default + named slots --}}
    <x-demo.section
        title="Default + named slots"
        description="Everything between the tags becomes the component's default slot. Content wrapped in a named livewire:slot arrives as a native named slot. The card below is a Vue component; its title, body, and footer are all authored in Blade on this page."
        :files="[
            'resources/views/livewire/pages/slots.blade.php',
            'app/Mesh/Slots/Card.php',
            'resources/js/mesh/Slots/Card/index.vue',
        ]"
    >
        <div class="max-w-xl mx-auto">
            <mesh:slots.card>
                ...
                <p>
                    ...
                    on the page, yet it renders inside a Vue component:
                </p>
                <ul class="mt-3 space-y-1.5 list-disc list-inside marker:text-zinc-600">
                    <li>The default slot renders through the component's <code class="px-1.5 py-0.5 rounded bg-white/5 text-zinc-300 font-mono text-xs">&lt;slot /&gt;</code></li>
                    <li>Named slots arrive as native Vue slots — <code class="px-1.5 py-0.5 rounded bg-white/5 text-zinc-300 font-mono text-xs">&lt;slot name="&hellip;" /&gt;</code></li>
    ...
    <x-demo.section
        ...
        description="Slot content is owned by the server. Mesh observes the hidden slot holder and morphs the rendered copy in place whenever a Livewire re-render changes it — type below and watch the HTML inside the Vue card update live, no remount."
        :files="[
        ...
        <div class="max-w-xl mx-auto space-y-5">
            ...
            <mesh:slots.card variant="cyan">
                ...
                <p class="mt-2">
                    ...
                    morphs the new HTML into the Vue card in place.
                </p>
            ...
            <div class="flex gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/5">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-zinc-400 leading-relaxed">
                        ...
                        into the Vue tree, not hydrated as live components. They stay reactive to server
            ...
            <div class="flex gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/5">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-zinc-400 leading-relaxed">
                        ...
                        holder and render dead in the Vue copy. Pass interactive pieces as their own Mesh
            ...
            <div class="flex gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/5">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-zinc-400 leading-relaxed">
                        ...
                        <code class="px-1.5 py-0.5 rounded bg-white/5 text-zinc-300 font-mono text-xs">innerHTML</code>.
