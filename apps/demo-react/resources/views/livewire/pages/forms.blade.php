<div class="space-y-12">
    <x-demo.page-header
        ...
        description="Laravel validation rules are the single source of truth — useErrorBag() streams the server error bag into React. No duplicated rules, no API endpoints. Define #[Validate] attributes on the Livewire properties and render the messages straight from the bag." />
