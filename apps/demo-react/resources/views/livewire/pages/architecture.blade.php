...
<span class="text-emerald-400">created</span> <span class="text-zinc-300">resources/js/mesh/Reports/Chart/index.tsx</span></code></pre>
                </div>
            </div>
        </div>
    </x-demo.section>
        ...
        <div class="space-y-6">
            <div class="grid gap-3 lg:grid-cols-[1fr_auto_auto_auto_1fr] lg:items-center">
                ...
                <div class="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    ...
                    <code class="text-sm font-mono text-zinc-400">resources/js/mesh/Forms/Input/index.tsx</code>
                </div>
            </div>
