<div class="space-y-12">
    ...
    >
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            <div class="space-y-4">
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">
                    Blade button <span class="text-cyan-400">&larr;&rarr;</span> the listening island
                </p>

                <div class="p-5 rounded-2xl bg-slate-800/60 border border-white/10">
                    <span class="text-xs font-semibold uppercase tracking-wider text-slate-500">Plain Blade · this page</span>
                    <p class="mt-2 text-sm text-slate-400 leading-relaxed">
                        This button is ordinary Blade + Livewire — <code class="text-cyan-300 text-xs">wire:click="pingIslands"</code>
                        dispatches <code class="text-cyan-300 text-xs">page.ping</code>, which the React island's PHP class catches.
                    </p>
                    <button
                        type="button"
                        wire:click="pingIslands"
                        class="mt-4 px-5 h-11 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 text-white text-sm font-semibold hover:from-cyan-600 hover:to-blue-600 active:scale-95 transition-all duration-150 shadow-lg shadow-cyan-500/25 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-slate-900"
                    >
                        Dispatch page.ping
                    </button>
                </div>
